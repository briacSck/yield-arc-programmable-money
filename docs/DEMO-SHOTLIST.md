...
| 5 | 1:20–1:50 | Fresh terminal, empty dir | Run the tarball command; let the 5/5 COMPLIANT verdict land | "One command. It replays the agent's entire on-chain history and re-checks every move against all five mandate invariants. Five for five, against the chain — not against us." |
